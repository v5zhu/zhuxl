package com.zhuxl.component.util.id.genertor;
...
public abstract class IdUtils {
    ...
    /**
     * 返回一个 IdUtils ，并用 64 进制转换成紧凑形式的字符串，内容为 [\\-0-9a-zA-Z_]
     * <p>
     * 比如一个类似下面的 IdUtils:
     * <p>
     * <pre>
     ...
     *    > IdUtils = uu.getMostSignificantBits();
    ...
    /**
     * 从一个 uu64 恢复回一个 IdUtils 对象
     *
     * @param uu64 64进制表示的 IdUtils, 内容为 [\\-0-9a-zA-Z_]
     * @return IdUtils 对象
     */
    ...
    /**
     * 将紧凑格式的 UU16 字符串变成标准 IdUtils 格式的字符串
     *
     * @param uu16
     * @return 标准 IdUtils 字符串
     */
     ...
     *
     * @param uu64
     *            uu64 64进制表示的 IdUtils, 内容为 [\\-0-9a-zA-Z_]
     * @return 16进制表示的紧凑格式的 IdUtils
     */
